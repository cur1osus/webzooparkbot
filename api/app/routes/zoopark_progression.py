...
from api.app.schemas.progression import AssignLocalityBody, BreedBody, BuyLocalityBody, OpenPackBody, ReleaseAnimalBody, StartExpeditionBody, UpgradeLocalityBody
