...
@tool("exchange_to_usd", "Обменять рубли на доллары по текущему курсу. Обмен в одну сторону — "
                         ...
                         "точно потратишь на доллары (паки, кузница, лечение). Курс — это сколько "
                         "рублей стоит доллар, он гуляет в диапазоне 60–130. ЧЕМ НИЖЕ КУРС, ТЕМ "
                         "БОЛЬШЕ ДОЛЛАРОВ ты получишь за те же рубли: 3 млн ₽ при курсе 60 дают "
                         "50000 $, а при курсе 100 — только 30000 $. Поэтому меняй, когда курс "
                         "НИЗКИЙ (ближе к 60), и жди, если курс высокий. Посмотри get_bank — там "
                         "история, лови дно.",
