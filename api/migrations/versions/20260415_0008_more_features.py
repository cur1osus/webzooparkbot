...
def upgrade() -> None:
    # Ежедневный бонус
    if not _table_exists("daily_claims"):
        op.create_table(
            "daily_claims",
    ...
    if not _table_exists("clan_members"):
        op.create_table(
            "clan_members",
            sa.Column("id", sa.Integer(), primary_key=True, nullable=False),
    ...
    # Раздача денег
    if not _table_exists("money_transfers"):
        op.create_table(
            "money_transfers",
            sa.Column("id", sa.Integer(), primary_key=True, nullable=False),
    ...
    if not _table_exists("transfer_claims"):
        op.create_table(
            "transfer_claims",
            sa.Column("id", sa.Integer(), primary_key=True, nullable=False),
