...
const TRACKS: Record<GlobalTrack, {
  ...
  genetics: {
    ...
    accent: 'var(--c-purple)',
    levels: [
      { level: 1, cost: 1_500, effects: ['к шансу успешного скрещивания добавляется 1%', 'шанс получить слабейший ген ниже на 1%'] },
      { level: 2, cost: 7_500, effects: ['к шансу успешного скрещивания добавляется 3%', 'шанс получить слабейший ген ниже на 3%'] },
      { level: 3, cost: 30_000, effects: ['к шансу успешного скрещивания добавляется 6%', 'шанс получить слабейший ген ниже на 6%'] },
      { level: 4, cost: 100_000, effects: ['к шансу успешного скрещивания добавляется 9%', 'шанс получить слабейший ген ниже на 9%'] },
      { level: 5, cost: 350_000, effects: ['к шансу успешного скрещивания добавляется 12%', 'шанс получить слабейший ген ниже на 12%'] },
    ],
  },
};
