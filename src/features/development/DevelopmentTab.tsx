...
const TRACKS: Record<GlobalTrack, {
  ...
  genetics: {
    ...
    accent: 'var(--c-purple)',
    levels: [
      { level: 1, cost: 1_500, effects: ['к шансу успешного скрещивания добавляется 5%', 'шанс получить слабейший ген ниже на 5%'] },
      { level: 2, cost: 7_500, effects: ['к шансу успешного скрещивания добавляется 10%', 'шанс получить слабейший ген ниже на 10%'] },
      { level: 3, cost: 30_000, effects: ['к шансу успешного скрещивания добавляется 15%', 'шанс получить слабейший ген ниже на 15%'] },
      { level: 4, cost: 100_000, effects: ['к шансу успешного скрещивания добавляется 20%', 'шанс получить слабейший ген ниже на 20%'] },
      { level: 5, cost: 350_000, effects: ['к шансу успешного скрещивания добавляется 25%', 'шанс получить слабейший ген ниже на 25%'] },
    ],
  },
};
