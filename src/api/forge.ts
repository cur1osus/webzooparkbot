...
export const apiForgeCreateSet = (item_ids: string[] = [], name?: string) =>
  req<{ ok: boolean; set: ForgeSet }>('/forge/sets/create', {
    method: 'POST',
...
export const apiForgeActivate = (item_id: string) =>
  req<{ ok: boolean; is_active: boolean; income_rub_per_min: number }>('/forge/activate', {
    method: 'POST',
